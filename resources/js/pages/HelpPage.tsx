                ...
                {activeTab === 'guide' && (
                    <div className="space-y-4 max-w-3xl">
                        ...
                        <div className="prose text-sm text-gray-600 space-y-4">
                            <p>Welcome to IDEMS. The typical workflow for running an examination is:</p>
                ...
                {activeTab === 'about' && (
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-gray-600 max-w-xl">
                            Iramba District Examination Management System (IDEMS) is built using Laravel 13, React 19, and PostgreSQL. It delivers high-efficiency educational data analytics and helps councils manage examination processing seamlessly.
                        </p>
