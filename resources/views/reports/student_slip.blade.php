...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <h3>District Examination & Results Management System (IDEMS)</h3>
        </div>
        ...
        {{-- FOOTER --}}
        <div class="footer">
            <p>Generated by IDEMS on {{ $generated_at }} | This is a computer-generated document.</p>
